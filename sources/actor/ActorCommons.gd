...
static func GetGenderName(gender : Gender) -> String:
	match gender:
		Gender.MALE:			return Localization.Text(genderMale)
		Gender.FEMALE:			return Localization.Text(genderFemale)
		Gender.NONBINARY:		return Localization.Text(genderNonBinary)
		_:						return Localization.Text(genderNonBinary)
