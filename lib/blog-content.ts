...
const sectionDisplays: Record<SectionSlug, SectionDisplay> = {
  games: {
    eyebrow: "游戏终端",
    sceneTitle: "进入游戏存档间",
    sceneSubtitle: "连夜开荒、联机熬夜和清单里的执念，都在这个发光角落里存档。",
    sceneTags: ["Boss 记录", "深夜联机", "重玩路线"],
    hudStats: [
      { label: "模式", value: "Boss 冲关" },
      { label: "设备", value: "PC / 主机 / 手机" },
    ],
    scenePanels: [
      { label: "主力设备", value: "屏幕冷光和随时重开" },
      { label: "常驻队友", value: "剧情单机和联机开黑" },
      { label: "存档习惯", value: "总想再来一局" },
    ],
    navLabel: "选择存档",
    groupLabel: "冒险支线",
    cardLabel: "存档位",
  ...
  rides: {
    eyebrow: "骑行终端",
    sceneTitle: "打开路线主机",
    sceneSubtitle: "城市绕骑、近郊出逃和长距离拉练，像解锁过的关卡一样排列在这里。",
    sceneTags: ["城市熟路", "近郊出逃", "长距离骑行"],
    hudStats: [
      { label: "节奏", value: "稳定巡航 / 耐力拉练" },
      { label: "地形", value: "城市 + 海边 + 起伏路" },
    ],
    scenePanels: [
      { label: "出发点", value: "清晨桥边和江岸" },
      { label: "最佳状态", value: "顺风或侧风的晴天" },
      { label: "收尾感受", value: "腿很空，脑子很清楚" },
    ],
    navLabel: "选择路线",
    groupLabel: "骑行路线",
    cardLabel: "路线记录",
  ...
  travel: {
    eyebrow: "地图控制台",
    sceneTitle: "查看旅行地图墙",
    sceneSubtitle: "城市、海岸线、站台和天气记忆，像已探索区域一样在地图上逐块亮起。",
    sceneTags: ["城市地图", "自然路线", "重访地点"],
    hudStats: [
      { label: "范围", value: "国内 + 海外" },
      { label: "关注点", value: "街道 / 光线 / 天气" },
    ],
    scenePanels: [
      { label: "当前视角", value: "站台与小街巷" },
      { label: "重访偏好", value: "海边和老城最多" },
      { label: "旅行方式", value: "慢慢走，慢慢看" },
    ],
    navLabel: "选择目的地",
    groupLabel: "地图分区",
    cardLabel: "地图图钉",
  ...
  books: {
    eyebrow: "书架档案",
    sceneTitle: "翻阅阅读仓库",
    sceneSubtitle: "小说、历史、非虚构和技术书，都像按类归档的收藏品一样排在这里。",
    sceneTags: ["小说", "历史", "非虚构", "技术书架"],
    hudStats: [
      { label: "书架状态", value: "高频重读" },
      { label: "索引", value: "文学 / 历史 / 产品" },
    ],
    scenePanels: [
      { label: "最常用", value: "书签与边角记忆" },
      { label: "检索方式", value: "情绪 + 结构 + 启发" },
      { label: "回看触发", value: "不同阶段重新翻开" },
    ],
    navLabel: "选择书架",
    groupLabel: "书架分层",
    cardLabel: "阅读札记",
  ...
  music: {
    eyebrow: "唱片控制台",
    sceneTitle: "让唱针落下",
    sceneSubtitle: "通勤歌单、深夜循环、原声带和华语常驻，像可切换的频道一样排开。",
    sceneTags: ["深夜低光", "通勤节奏", "原声模式"],
    hudStats: [
      { label: "频道", value: "循环 / 通勤 / 原声" },
      { label: "高峰时段", value: "夜间播放" },
    ],
    scenePanels: [
      { label: "主要设备", value: "桌面音箱和耳机" },
      { label: "情绪切换", value: "从城市节奏转入低光" },
      { label: "循环规则", value: "一首歌点亮一个场景" },
    ],
    navLabel: "选择频道",
    groupLabel: "听歌分组",
    cardLabel: "曲目备注",
    ...
    groups: [
      {
        ...
        entries: [
          { title: "Baldur's Gate 3", meta: "角色扮演 / Larian", note: "营地对话和支线选择比主线还更容易让人上头。" },
          { title: "Cyberpunk 2077", meta: "开放世界 / CDPR", note: "会为了夜之城的灯光和电台故意绕远路。" },
          { title: "Disco Elysium", meta: "叙事角色扮演 / ZAUM", note: "每次重开都像在选择另一种失控方式。" },
          { title: "Hades", meta: "类 Rogue / Supergiant", note: "输掉也不会生气，因为每一轮都能推进新的对白。" },
        ],
      },
      {
        id: "console",
      ...
      },
      {
        ...
        entries: [
          { title: "Honkai: Star Rail", meta: "手机 / 电脑", note: "角色演出和地图气氛总会让我想多逛一圈。" },
          { title: "Arknights", meta: "手机", note: "找到布阵思路的一瞬间特别像点亮一张网。" },
          { title: "Marvel Snap", meta: "手机", note: "一局很短，但变化很多，特别适合碎片时间。" },
  ...
  travel: {
    ...
    groups: [
      ...
      },
      {
        ...
        entries: [
          { title: "东京", meta: "霓虹与秩序", note: "从电车节奏到便利店补给都很精确，但深夜小巷又意外松弛。" },
          { title: "京都", meta: "寺院与慢步", note: "清晨出门很重要，人少的时候整座城像在低声讲话。" },
          { title: "首尔", meta: "上坡与咖啡馆", note: "年轻气和夜生活的密度都很高。" },
          { title: "香港", meta: "密度与海港", note: "高楼和坡道之间挤满了生活细节。" },
        ],
      },
      {
        ...
        entries: [
          { title: "河口湖", meta: "富士山前景", note: "天气好时画面过于标准，反而会让人安静下来认真看很久。" },
          { title: "奈良", meta: "鹿与草地", note: "走远一点，风声和树影会把空间重新拉开。" },
          { title: "济州", meta: "海岸公路", note: "火山石、海浪和风一起出现时，路线会很适合慢慢开。" },
          { title: "北海道小樽", meta: "冬天版本", note: "雪和港口灯光叠在一起，特别像电影场景。" },
        ],
      },
    ],
  },
    ...
    groups: [
      {
        ...
        entries: [
          { title: "Nujabes", meta: "爵士嘻哈", note: "总能把夜晚整理得更平静，像给思绪铺了一层柔和底噪。" },
          { title: "Cigarettes After Sex", meta: "梦核流行", note: "听感像雾，特别适合城市灯光已经变稀的时段。" },
      ...
      },
      {
        ...
        entries: [
          { title: "Daft Punk", meta: "法式浩室", note: "节拍非常适合走路和骑车，会自动把速度提起来。" },
          { title: "The Weeknd", meta: "合成器流行 / 节奏蓝调", note: "夜晚城市感很强，地铁窗外的倒影会被它放大。" },
          { title: "M83", meta: "Electronic", note: "适合快速移动时听，像给现实叠了一层电影滤镜。" },
          { title: "椎名林檎", meta: "日系流行", note: "节奏和气质都很鲜明，通勤路上听会有种锋利感。" },
        ],
      },
      {
        id: "soundtrack",
        ...
        entries: [
          { title: "Persona 5 OST", meta: "游戏原声", note: "时髦、流畅、上头，一响起就自动切进行动模式。" },
          { title: "NieR: Automata OST", meta: "游戏原声", note: "空旷、悲伤又很漂亮，适合独处时慢慢听完整张。" },
          { title: "Interstellar OST", meta: "电影配乐", note: "空间感和推进感特别强，很适合专注时循环。" },
          { title: "久石让精选", meta: "动画配乐", note: "是那种会让整个房间一起变亮一点的音乐。" },
        ],
      },
      {
        id: "mandarin",
